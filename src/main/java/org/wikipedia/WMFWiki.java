...
public class WMFWiki extends Wiki
{
    ...
    {
        WMFWiki wiki = new WMFWiki("meta.wikimedia.org");
        wiki.setMaxLag(0);
        System.out.println(wiki.isUsingCompressedRequests());
        String line = wiki.fetch("https://meta.wikimedia.org/w/api.php?format=xml&action=sitematrix", "WMFWiki.getSiteMatrix");
